...
tempF= []
pressure=[]
port = input('Enter Arduino port name: ')

# Temperature thresholds
input("Enter thresholds for the mushroom species")
upperthres = float(input("Enter upper temperature threshold: "))
lowerthres = float(input("Enter lower temperature threshold: "))
